...
```
```bash
docker build -f Dockerfile -t docker.gtjaqh.net/flink:test .
docker push docker.gtjaqh.net/flink:test
```
...
bin/flink run-application \
  ...
  -Dkubernetes.container.image=docker.gtjaqh.net/flink:test \
