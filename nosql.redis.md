...
<a name="bnJCx"></a>
# Redis 安装手册
![](https://redis.io/images/redis-white.png#crop=0&crop=0&crop=1&crop=1&height=164&id=sesjk&originHeight=80&originWidth=240&originalType=binary&ratio=1&rotation=0&showTitle=false&status=done&style=none&title=&width=493)
